...
const UserMenu = () => {
  ...
  return <>
    {!hasWallet && 
      <Link href={'/'}><a><Button type="primary">Login</Button></a></Link>
    }
      ...
      <>
        { !enoughEther && 
          <a href={`https://goerli-faucet.slock.it/?address=${address}`} target="_blank">
            <Button danger type="primary">Not enough Ether</Button>
          </a>
        }
        <UserOutlined style={{marginLeft:"10px"}} /> <span className="md-noShow">Connected</span>
      </>
    }
  </>
}
