...
module.exports = {
    ...
    // GATEWAYS
    BOOTNODES_URL_READ_ONLY: process.env.BOOTNODES_URL_READ_ONLY || (
        DEVELOPMENT
            ? 'https://bootnodes.vocdoni.net/gateways.dev.json'
            : 'https://bootnodes.vocdoni.net/gateways.json'
    ),
    BOOTNODES_URL_RW: process.env.BOOTNODES_URL_RW || (
        DEVELOPMENT
            ? 'https://bootnodes.vocdoni.net/gateways.dev.json'
            : 'https://bootnodes.vocdoni.net/gateways.json'
    ),
    ...
    EXPLORER_URL: process.env.EXPLORER_URL || (
        DEVELOPMENT
            ? 'https://explorer.dev.vocdoni.net'
            : 'https://explorer.vocdoni.net'
    ),
